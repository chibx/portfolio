...
const { remove } = useObserver(projectsEl, (entries) => {
      entries.forEach((entry) => {
          if (entry.isIntersecting) {
              ...
              animate(projects, { opacity: [0, 1], transform: ['translate(50px, 100px) scale(0.75)', ''] }, { duration: 0.5, delay: stagger(0.3), ease: 'easeOut' }).then(() => {
...
<template>
    <div class="projects mt-20" ref="projects">
        <div v-for="project, i in projects.slice(0, count)" class="project opacity-0" :aria-label="`Project Name - ${project.name}`" :aria-describedby="`project-description-${i}`">
            ...
            <div class="details flex flex-col mt-2.5 px-5">
                ...
                <div class="links flex gap-4 my-3">
                    ...
                    <a v-if="project.github" :href="project.github" target="_blank" rel="noopener noreferrer" title="Check my project on GitHub">
